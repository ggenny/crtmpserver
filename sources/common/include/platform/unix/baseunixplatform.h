...
#define CLOSE_SOCKET(fd) SOCKET_CLOSE(fd)
...
#define LASTSOCKETERROR                 SOCKET_LAST_ERROR
#define SOCKERROR_EINPROGRESS           SOCKET_ERROR_EINPROGRESS
#define SOCKERROR_EAGAIN                SOCKET_ERROR_EAGAIN
#define SOCKERROR_EWOULDBLOCK           SOCKET_ERROR_EWOULDBLOCK
#define SOCKERROR_ECONNRESET            SOCKET_ERROR_ECONNRESET
#define SOCKERROR_ENOBUFS               SOCKET_ERROR_ENOBUFS
